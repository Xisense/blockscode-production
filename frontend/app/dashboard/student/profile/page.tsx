...
export default function ProfilePage() {
    ...
    useEffect(() => {
        async function loadProfile() {
            try {
                // Use checkSession or direct getUser
    ...
    const handleUpdateProfile = async () => {
        ...
        try {
            ...
            toast(error.message || "Something went wrong", "error", "Update Failed");
        } finally {
            setSaving(false);
        }
    };
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <div className="flex flex-wrap justify-center md:justify-start gap-3">
                            ...
                            <span className="px-4 py-1.5 bg-slate-100 text-slate-500 text-[11px] font-black uppercase tracking-widest rounded-full">
                                Student ID: #{userData?.rollNumber || userData?.id.substring(0, 8)}
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex-1 w-full bg-white rounded-3xl border border-slate-100 p-10 shadow-sm min-h-[500px] animate-in slide-in-from-right-4 duration-500">
                        {activeTab === 'general' ? (
                            <div className="space-y-8 max-w-2xl">
                                <div>
                                    <h2 className="text-xl font-black text-slate-800 mb-2">Account Settings</h2>
                                    <p className="text-sm font-medium text-slate-400">Update your personal information and public profile.</p>
                                </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        />
                                        <p className="text-[10px] font-medium text-slate-400 mt-1 italic">Email cannot be changed manually. Please contact support.</p>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-8 max-w-2xl">
                                <div>
                                    ...
                                    <p className="text-sm font-medium text-slate-400">Manage your password and security preferences.</p>
                                </div>
