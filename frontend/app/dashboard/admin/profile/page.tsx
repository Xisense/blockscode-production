                ...
                <div className="bg-white rounded-3xl border border-slate-100 p-8 mb-8 shadow-sm flex flex-col md:flex-row items-center gap-8 animate-in fade-in slide-in-from-top-4 duration-500">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <div className="flex flex-wrap justify-center md:justify-start gap-3">
                            <span className="px-4 py-1.5 bg-rose-50 text-rose-600 text-[11px] font-black uppercase tracking-widest rounded-full border border-rose-100">
                            ...
                            <span className="px-4 py-1.5 bg-slate-100 text-slate-500 text-[11px] font-black uppercase tracking-widest rounded-full">
                                Staff ID: #{userData?.id?.substring(0, 8) || "N/A"}
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex-1 w-full bg-white rounded-3xl border border-slate-100 p-10 shadow-sm min-h-[500px] animate-in slide-in-from-right-4 duration-500">
                        {activeTab === 'general' ? (
                            <div className="space-y-8 max-w-2xl">
                                <div>
                                    <h2 className="text-xl font-black text-slate-800 mb-2">Administrative Profile</h2>
                                    <p className="text-sm font-medium text-slate-400">Manage your institution administrative identity.</p>
                                </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[11px] font-black uppercase tracking-widest text-slate-400">Admin Email</label>
                                        <input
                                            type="email"
                            ...
                            <div className="space-y-8 max-w-2xl">
                                <div>
                                    ...
                                    <p className="text-sm font-medium text-slate-400">Manage your administrative account security.</p>
                                </div>
